...
//        [self.navigationController.navigationBar setBackgroundImage:topBarImg forBarPosition:UIBarPositionTop barMetrics:UIBarMetricsDefault];
        self.navigationController.navigationBar.barTintColor  =[UIColor colorWithRed:65.0/255.0 green:196.0/255.0 blue:51.0/255.0 alpha:0.5];
        #endif
        
    }
    else{
        self.navigationController.navigationBar.tintColor  =[UIColor colorWithPatternImage:topBarImg];
